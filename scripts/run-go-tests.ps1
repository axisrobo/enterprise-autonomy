...
$adapters = @("order-domain", "inventory-domain", "procurement-domain", "customer-domain", "recruitment-domain", "maintenance-domain", "integration-domain", "simulation-domain", "compliance-domain", "fleet-domain", "process-domain", "sandbox-domain")
$failures = @()
