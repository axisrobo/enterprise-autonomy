...
1. **Open** — the hiring manager opens a governed requisition case.
2. **Validate** — the TA lead validates the requisition and records criteria.
3. **Automation boundary** — an automated assistant's decision is rejected.
4. **Shortlist** — the panel records a human shortlist decision.
5. **Process** — a durable hiring process is opened.
6. **Plan** — a verified hiring plan is generated (recommendation only).
7. **Select and offer** — the hiring manager records selection and offer decisions; the TA lead issues the offer.
8. **Close** — the requisition closes and the value report is emitted.
