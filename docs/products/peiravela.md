# Peiravela — Simulation and Experiment Control Plane
...
- [Simulation-to-validation](../../vertical-slices/simulation-to-validation.md) — review before live use
- [Facility inspection](../../reference-stacks/facility-inspection.md) — simulation before live operation
- [Innovation sandbox to policy](../../vertical-slices/innovation-sandbox-to-policy.md) — possible-world experimentation
